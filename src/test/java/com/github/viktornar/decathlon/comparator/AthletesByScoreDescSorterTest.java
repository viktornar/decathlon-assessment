...
public class AthletesByScoreDescSorterTest {
    ...
    public void compare() throws Exception {
        csvDecoder.decode(linesToParse.get(0)).getResult().setScore(3);
        csvDecoder.decode(linesToParse.get(1)).getResult().setScore(1);
        csvDecoder.decode(linesToParse.get(2)).getResult().setScore(2);
